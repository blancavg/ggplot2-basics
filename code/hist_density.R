...
# To compare the distributions of different subgroups, just add an aesthetic mapping. Mapping a categorical variable to an aesthetic will automatically split up the geom by that variable, so these commands instruct qplot() to draw a density plot and histogram for each level of diamond colour.
